...
public class FileHandeling {
	...
	public static void writeToEmployeeFile() {
		...
		try {
			...
			while(id!=QUIT) {
				...
				// her burde det v�rt en tilbakemelding til brukeren om at data er lagret til fil... 
	...
	public static void readEmployeeFile() {
		...
		// OBS denne overskrider tidligere lagret data, dersom det finnes noe i filen fra f�r av. 
		Path file = Paths.get("C:\\Temp\\Test3.txt");
		String s = ""; 
